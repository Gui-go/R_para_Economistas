...
- Formulas em torno de dois cifrões serão isoladas em uma nova linha $$ x^2 + y^2 = z^2 $$


## Podemos até mesmo incluir código de outras liguagens, como Python, JavaScript, C++, etc
```{python ling2}
